...
// Grok runs under /workspace; local contributors may run this repository on
// another absolute path. In both cases screenshots remain confined to the
// current repository tree.
const ALLOWED_OUTPUT_DIRS = ["/workspace", realpathSync(process.cwd())];
